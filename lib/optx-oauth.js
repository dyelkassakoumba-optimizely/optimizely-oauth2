...
OptimizelyOauth.prototype = {
  ...
  _returnRefreshUrl: function (opts) {
    ...
    return `${this.host}token?refresh_token=${opts._query.refresh_token}&client_id=${this._query.client_id}&client_secret=${this._query.client_secret}&grant_type=refresh_token`
  },
